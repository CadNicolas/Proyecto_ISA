      ...
      <div class="card">
        ...
        <div class="p-4">
          ...
          <!--form class="p-4" method="POST" action="solicitud.php"  enctype="multipart/form-data">
            ...
            <a class="btn btn-outline-success mt-3 w-100" href="../estudiante/indexsol.php" role="button">Hacer solicitud</a>
            <form class="p-4">
            ...
            <form class="p-3" >
            <a class="btn btn-primary  mt-4 w-100" href="../estudiante/asesorest.php" role="button">Lista de jurados y asesores</a>
            </form>
