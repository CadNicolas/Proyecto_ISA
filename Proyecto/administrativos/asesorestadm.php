      ...
      <div class="card">
        ...
        <div class="p-4">
          <table class="table aling-middle">
            <thead>
            <tr>
                <th scope="col">Identificacion Estud</th>
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td><a onclick="return confirm('¿Estas Seguro de eliminar esta cuenta?')" class="text-danger" href="eliminarjur.php?codigo=<?php echo $dato->codigo; ?>"><i class="bi bi-trash3-fill"></a></td>
                  </tr>
              <?php
                }
              ?>
        ...
        <div class="card-footer">
          <a href="../administrativos/homestudent.php" class="btn btn-outline-danger w-100 ">Regresar o Salir <i class="bi bi-box-arrow-left"></i></a>
        </div>
      </div>
    </div>
  </div>
