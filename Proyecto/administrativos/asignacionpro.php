            ...
            <tbody>
              ...
              ?>
                  ...
                  <th>
                    ...
                    <td><a onclick="return confirm('¿Estas Seguro de eliminar esta cuenta?')" class="text-danger" href="eliminarpro.php?identificacion=<?php echo $dato->identificacion; ?>"><i class="bi bi-trash3-fill"></a></td>
                    </tr>
