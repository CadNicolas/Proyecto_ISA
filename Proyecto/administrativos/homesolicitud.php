          ...
          <table class="table aling-middle">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                  <th>
                    <td scope="row"><?php echo $dato->idsolicitud; ?></td>
                    <td><?php echo $dato->asunto; ?></td>
                    <td><?php echo $dato->nombredoc; ?></td>
                    <td><a onclick="return confirm('¿Estas Seguro de eliminar esta cuenta?')" class="text-danger" href="eliminarproy.php?idsolicitud=<?php echo $dato->idsolicitud; ?>"><i class="bi bi-trash3-fill"></a></td>  
